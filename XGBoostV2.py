...
def mainRun(expressionFile,goldFile,samples,outputfile,p_lambda=0,p_alpha=1,maxlag=2,timelag=2):
    ...
    for index in range(0, len(data.columns)):
        ...
        clfx = xgb.XGBRegressor(n_jobs=2,max_depth=3,n_estimators=1000,learning_rate=0.0001,subsample=0.8,reg_lambda=p_lambda,reg_alpha=p_alpha,colsample_bylevel=0.6,colsample_bytree=0.6,seed=seed)
        ...
        clf = xgb.XGBRegressor(n_jobs=2,max_depth=3,n_estimators=1000,learning_rate=0.0001,subsample=0.8,reg_lambda=p_lambda,reg_alpha=p_alpha,colsample_bylevel=0.6,colsample_bytree=0.6,seed=seed)
